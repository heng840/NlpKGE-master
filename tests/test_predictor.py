...
from nlpkge import *
from nlpkge.data.lut import LookUpTable
import pickle

device = init_nlpkge(device_id="5", seed=1)
with open("/data/mentianyi/code/NlpKGE/dataset/WIKIPEDIA5M/processed_data/vocab.pkl", "rb") as file:
...
model.load_state_dict(torch.load(
    "/data/mentianyi/code/NlpKGE/dataset/WIKIPEDIA5M/experimental_output/TransE2022-06-04--19-20-22.14--500epochs/checkpoints/TransE_100epochs/Model.pkl"))
